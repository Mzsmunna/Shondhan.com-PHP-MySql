...
<html lang="en">
  ...
  <body>
    <?php
        ...
        //CHECK IF USER LOGGED IN OR NOT & STORE DATA IN SESSION!
        ...
        //RECEIVE PARTICULAR ADD DATA ON UPDATE BUTTON CLICK!
...
-->
        ...
        <?php
            ...
            //DELETE BUTTON CLICK WARNING POP UP!
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Advertises - Grid 3 View | </li>
        <li class="ml-4">
...
-->
    ...
    {
        //alert("closing");
        document.location.href='advertises-g3.php';
