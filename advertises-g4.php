...
<html lang="en">
  ...
  <body>
    <?php
        ...
        //CHECK IF USER ALREADY LOGGED IN OR NOT AND SAVE DTA IN SESSION!
        ...
        //RECEIVE DATA FORM SEEVER ON UPDATE BUTTON CLICK!
...
-->
        ...
        <?php
            ...
            <!-- WARNING POP UP ON DELETE BUTTON CLICK! -->
    <div id="simpleModal" class="modal">
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Advertises - Grid 4 View | </li>
        <li class="ml-4">
          <a href="portfolio-1-col.php">Grid 1 View</a>
        </li>
        <li class="ml-4">
...
<!--      <div class="row">-->
       <!-- FORMAT ADD DATA INTO HTML FORMAT | PAGE CONTENT -->
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="<?php echo $getPic; ?>" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="portfolio-item.php?aid=<?php echo $addID; ?> "><?php echo $addType; ?> For <?php echo $addFor; ?></a>
              </h4>
              <p class="card-text"><a class="btn btn-danger disabled" href=""><?php echo $price; ?>
            <span class="glyphicon glyphicon-chevron-right"></span>
          </a></p>
          ...
          <a class="btn btn-danger mt-1" href="?deleteAdd=<?php echo $addID; ?> ">Delete
            <span class="glyphicon glyphicon-chevron-right"></span>
          </a>
                              <?php
                        }
...
-->
    ...
    {
        //alert("closing");
        document.location.href='advertises-g4.php';
