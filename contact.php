      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          ...
          <p>
            ...
            <a href="mailto:name@example.com">xyz@shondhan.com
            </a>
          </p>
          <p>
            <abbr title="Hours">H</abbr>: Saturday - Thursday : 9:00 AM to 5:00 PM
          </p>
        </div>
      </div>
      <!-- /.row -->
