<?php
    ...
    $resultset = $mysqli->query("SELECT * FROM advertises WHERE price LIKE '%".$price."%' AND bed like '%".$bed."%' AND masterBeed like '%".$mstrBed."%' AND belcony like '%".$belcony."%' AND squareFeet like '%".$sqr_ft."%' AND division like '%".$division."%' AND district like '%".$district."%' AND addType like '%".$property."%' ORDER BY aid DESC");
